...
public record CalificacionCarrera(String value) {

  private static final int MAX_LENGTH = 60;
  private static final String FIELD_NAME = "carrera";

  public CalificacionCarrera {
    final String normalizedValue =
        Objects.requireNonNull(value, "Carrera cannot be null").trim();
