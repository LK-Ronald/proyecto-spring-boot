...
public record CalificacionEstudiante(String value) {

  private static final int MAX_LENGTH = 100;
  private static final String FIELD_NAME = "estudiante";

  public CalificacionEstudiante {
    final String normalizedValue =
        Objects.requireNonNull(value, "Estudiante cannot be null").trim();
