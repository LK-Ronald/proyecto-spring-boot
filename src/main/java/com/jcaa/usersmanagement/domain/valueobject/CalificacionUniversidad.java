...
public record CalificacionUniversidad(String value) {

  private static final int MAX_LENGTH = 100;
  private static final String FIELD_NAME = "universidad";

  public CalificacionUniversidad {
    final String normalizedValue =
        Objects.requireNonNull(value, "Universidad cannot be null").trim();
