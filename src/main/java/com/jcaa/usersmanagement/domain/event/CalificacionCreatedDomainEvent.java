...
@Getter
public final class CalificacionCreatedDomainEvent extends DomainEvent {

  private static final String EVENT_NAME = "calificacion.created";

  private final CalificacionModel calificacion;

  public CalificacionCreatedDomainEvent(final CalificacionModel calificacion) {
    super(EVENT_NAME);
